...
Функция translate3d () CSS перемещает позицию элемента в трехмерном пространстве.

Ресурсы: ** <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function#translate3d()"> MDN </a> **
...
**Советы и приемы:**
   ...
   Если вы опускаете единицы, `translate3d` автоматически добавляет` px`.
